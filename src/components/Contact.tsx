...
export default function Contact() {
  ...
  const contacts = [
    ...
    { label: "Oblast", value: "Středočeský & Liberecký kraj", href: undefined, icon: "M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0ZM12 10a3 3 0 1 0 0 6 3 3 0 0 0 0-6Z" },
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1.3fr", gap: "7rem", alignItems: "start" }} className="contact-grid">
          <div className="reveal reveal-delay-1">
            ...
            <div style={{ marginTop: "1rem", padding: "1.8rem 2rem", background: "linear-gradient(135deg,rgba(232,101,10,0.08),rgba(232,101,10,0.03))", border: "1px solid rgba(232,101,10,0.2)" }}>
              <div style={{ fontFamily: "var(--font-ui)", fontSize: "0.58rem", letterSpacing: "0.4em", color: "var(--ember)", textTransform: "uppercase", marginBottom: "0.6rem" }}>Pohotovostní linka</div>
              ...
              <p style={{ fontFamily: "var(--font-ui)", fontSize: "0.75rem", color: "var(--text-muted)", marginTop: "0.5rem", lineHeight: 1.7, fontWeight: 300 }}>Tomáš Baran — Mladá Boleslav a okolí.</p>
            </div>
          </div>
          ...
          <div className="reveal reveal-delay-2" style={{ display: "flex", flexDirection: "column", gap: "0.8rem" }}>
            ...
            <select className="form-input form-select">
              ...
              {["Čištění komínu","Revize komínu","Oprava komínu","Vložkování","Rekonstrukce komínu","Instalace nového komínu","Kouřovody a spalinové cesty","Jiný požadavek"].map(s => <option key={s}>{s}</option>)}
            </select>
