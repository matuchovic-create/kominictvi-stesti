    ...
    <div ref={sectionRef} style={{ position: "relative", background: "var(--black)" }}>
      ...
      <div style={{ display: "flex", borderTop: "1px solid rgba(255,255,255,0.04)", background: "rgba(8,8,8,0.98)" }}>
        {[
          ...
          { icon: "M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2ZM22 6l-10 7L2 6", label: "E-mail", value: "info@kominictvi-stesti.cz", href: "mailto:info@kominictvi-stesti.cz" },
        ].map((item, i) => (
