      ...
      <nav style={{
        ...
        <a href="#hero" style={{ textDecoration: "none", display: "flex", flexDirection: "column", gap: "2px", zIndex: 1001 }}>
          <span style={{ fontFamily: "var(--font-cormorant)", fontSize: "1.1rem", fontWeight: 400, letterSpacing: "0.2em", color: "var(--text-primary)", lineHeight: 1 }}>
            KOMINICTVÍ <span style={{ color: "var(--ember)" }}>ŠTĚSTÍ</span><Clover /><svg width="42" height="42" viewBox="0 0 80 80" style={{ display: "inline-block", verticalAlign: "middle", marginLeft: "5px" }}><defs><radialGradient id="nl1" cx="35%" cy="35%" r="75%"><stop offset="0%" stopColor="#bbf7d0"/><stop offset="35%" stopColor="#4ade80"/><stop offset="70%" stopColor="#16a34a"/><stop offset="100%" stopColor="#14532d"/></radialGradient><radialGradient id="nl2" cx="65%" cy="35%" r="75%"><stop offset="0%" stopColor="#86efac"/><stop offset="35%" stopColor="#22c55e"/><stop offset="70%" stopColor="#15803d"/><stop offset="100%" stopColor="#14532d"/></radialGradient><radialGradient id="nl3" cx="35%" cy="65%" r="75%"><stop offset="0%" stopColor="#86efac"/><stop offset="35%" stopColor="#22c55e"/><stop offset="70%" stopColor="#166534"/><stop offset="100%" stopColor="#052e16"/></radialGradient><radialGradient id="nl4" cx="65%" cy="65%" r="75%"><stop offset="0%" stopColor="#bbf7d0"/><stop offset="35%" stopColor="#4ade80"/><stop offset="70%" stopColor="#16a34a"/><stop offset="100%" stopColor="#052e16"/></radialGradient><radialGradient id="nc" cx="35%" cy="35%" r="80%"><stop offset="0%" stopColor="#86efac"/><stop offset="100%" stopColor="#14532d"/></radialGradient></defs><style>{"@keyframes nb{0%,100%{transform:rotate(-2deg) scale(1)}50%{transform:rotate(2deg) scale(1.04)}}"}</style><g className="clover-whole"><g className="clover-l2" transform="translate(40,40) rotate(-45)"><path d="M0,0 C1,-2 2,-12 0,-16 C-3,-20 -10,-19 -14,-15 C-17,-12 -16,-6 -12,-3 C-9,-1 3,2 0,0 Z" fill="url(#nl1)"/><path d="M0,0 C-2,-3 -7,-9 -11,-13" stroke="#166534" strokeWidth="0.4" fill="none" opacity="0.6"/></g><g className="clover-l3" transform="translate(40,40) rotate(45)"><path d="M0,0 C1,-2 2,-12 0,-16 C-3,-20 -10,-19 -14,-15 C-17,-12 -16,-6 -12,-3 C-9,-1 3,2 0,0 Z" fill="url(#nl2)"/><path d="M0,0 C-2,-3 -7,-9 -11,-13" stroke="#166534" strokeWidth="0.4" fill="none" opacity="0.6"/></g><g className="clover-l4" transform="translate(40,40) rotate(-135)"><path d="M0,0 C1,-2 2,-12 0,-16 C-3,-20 -10,-19 -14,-15 C-17,-12 -16,-6 -12,-3 C-9,-1 3,2 0,0 Z" fill="url(#nl3)"/><path d="M0,0 C-2,-3 -7,-9 -11,-13" stroke="#166534" strokeWidth="0.4" fill="none" opacity="0.6"/></g><g className="clover-l5" transform="translate(40,40) rotate(135)"><path d="M0,0 C1,-2 2,-12 0,-16 C-3,-20 -10,-19 -14,-15 C-17,-12 -16,-6 -12,-3 C-9,-1 3,2 0,0 Z" fill="url(#nl4)"/><path d="M0,0 C-2,-3 -7,-9 -11,-13" stroke="#166534" strokeWidth="0.4" fill="none" opacity="0.6"/></g><circle cx="40" cy="40" r="4" fill="#052e16"/><circle cx="40" cy="40" r="2.5" fill="url(#nc)"/><circle cx="39" cy="39" r="1" fill="#bbf7d0" opacity="0.9"/></g></svg>
          </span>
